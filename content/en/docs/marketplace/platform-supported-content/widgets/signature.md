...
8. When the form is submitted—which can be triggered by the start of a microflow or a save—the signature is captured and stored as an image. To view the result, the [Image](https://docs.mendix.com/appstore/widgets/image/) widget can be used.
